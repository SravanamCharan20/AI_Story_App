    ...
    <SafeAreaView className="flex-1 bg-black">
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <View className="flex-row items-center mb-6 space-x-4">
            <TouchableOpacity 
            className="flex-row items-center space-x-2 bg-white/10 rounded-full px-3 py-2" 
            ...
            <Text className="text-sm text-gray-400">Upload your audio and story files</Text>
            </View>
        </View>
        </View>
